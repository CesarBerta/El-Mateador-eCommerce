...
const adminController = { 
    ...
    //Admin todos los productos administrador
    ...
    create: async (req, res) => {
        try {
            ...
            res.status(500).send("Error ingreso Form.Create -> " + error);
        }
    },
    ...
    store: async function (req,res) {
        ...
        try {
            ...
            res.send("Controller: No se pudo crear -> " + error);
        } 
    } else {
        ...
        try {
            ...
            Promise.all([categorias, colores, imagenes])
                ...
                .catch(error => {
                    ...
                    res.status(500).send("Error ingreso Form.Edit -> " + error);
                });
        } catch (error) {
    ...
    update: async function(req, res) {
        try {
            ...
            res.send("Controller: No se pudo editar -> " + error);
        }
    },
    ...
    delete: async function(req, res) {
        try {
            ...
            res.send("Error ingreso Form.Delete -> " + error).status(500);
        }    
    },
    ...
    destroy : async function(req, res) {
        try {
            ...
            res.send("Controller: No se pudo borrar -> " + error);
        }
    }
};
